...
# /etc/puppetlabs/code/environments/production/site/profiles/manifests/middleware.pp

# @summary Production profile: configures a middleware (application tier) node.
#
...
#
# Applies to: middleware RHEL nodes in the production environment.
#
class profiles::middleware {
  ...
  # Install Java 21 OpenJDK. Required by both Kafka and Java applications.
