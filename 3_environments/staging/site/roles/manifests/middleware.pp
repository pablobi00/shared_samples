...
# /etc/puppetlabs/code/environments/staging/site/roles/manifests/middleware.pp

# @summary Role: RHEL middleware (application tier) node for the staging environment.
#
# A role defines WHAT a node IS by assembling profiles.
# This role is assigned to all staging middleware nodes.
#
# Profiles included:
...
#
# Node naming convention (see manifests/site.pp): stg-middleware-<name>.example.com
#
